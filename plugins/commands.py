...
main_buttons = [[
        InlineKeyboardButton('📢 Updates', url='https://t.me/pere_official'),
        InlineKeyboardButton('💬 Support', url='https://t.me/pere_official')
        ],[
        InlineKeyboardButton('🛠️ Help', callback_data='help'),
        InlineKeyboardButton('🩷 About', callback_data='about')
        ],[
        InlineKeyboardButton('🧑‍💻 Developer 🧑‍💻', url='https://t.me/Pere_dude')
        ]]
